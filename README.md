# The Ruby Style Guide: April 5, 2014 version

This is the ruby style guide back when I first found it, on April 9, 2014.
Since then, it has grown by 56% to over 4,600 lines of Markdown at the time of
writing. It seems it will only go up from there. Many practices have been
adopted that I don't feel were justified, and rules have been changed from what
they once were, making "keeping up with the style guide" a requirement for a
Ruby developer on a team which uses it. I think that's ridiculous and a waste
of time. I think the version back in 2014 was Just Fine, so here it is.
